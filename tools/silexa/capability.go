...
Tools: git, node/pnpm, playwright, MCP gateway (catalog), image builder (docker), per-app DB DSN
...
Guardrails: enforce smoke/visual before approval; no prod secrets`, true
