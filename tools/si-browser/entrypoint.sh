...
# Xvfb can take a moment to create the X11 socket. If x11vnc starts too early it
# exits and noVNC will never connect (you'll get a blank page or connection error).
