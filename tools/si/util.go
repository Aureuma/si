...
Features:
  ...
  - AWS bridge: auth/context diagnostics plus IAM, STS, S3, EC2, Lambda, ECR, Secrets, KMS, DynamoDB, SSM, CloudWatch, Logs, and signed raw API access.
...
Core:
  ...
  si aws <auth|context|doctor|iam|sts|s3|ec2|lambda|ecr|secrets|kms|dynamodb|ssm|cloudwatch|logs|raw>
