...
const (
	...
	paasDeployUsageText   = "usage: si paas deploy [--app <slug>] [--target <id>] [--targets <id1,id2|all>] [--strategy <serial|rolling|canary|parallel>] [--max-parallel <n>] [--continue-on-error] [--release <id>] [--compose-file <path>] [--bundle-root <path>] [--apply] [--remote-dir <path>] [--apply-timeout <duration>] [--vault-file <path>] [--wait-timeout <duration>] [--allow-plaintext-secrets] [--allow-untrusted-vault] [--json]"
	paasRollbackUsageText = "usage: si paas rollback [--app <slug>] [--target <id>] [--targets <id1,id2|all>] [--to-release <id>] [--strategy <serial|rolling|canary|parallel>] [--max-parallel <n>] [--continue-on-error] [--wait-timeout <duration>] [--vault-file <path>] [--allow-untrusted-vault] [--json]"
