...
| WS-06 | Logs/health/Telegram alerts + audit/event model | WS-04 | In Progress | Codex | 2026-02-17 | 2026-02-21 | None | WS06-01 completed with live `si paas logs` + `si paas events list` backends (SSH log retrieval, merged deploy/alert event query, severity/status filters, JSON/text contracts) and WS06-07 completed (`alert ingress-tls`); WS06-02..06 pending |
