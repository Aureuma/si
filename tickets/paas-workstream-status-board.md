...
| WS-05 | Vault and secret workflows | WS-02, WS-03 | In Progress | Codex | 2026-02-17 | 2026-02-21 | None | WS05-01..WS05-05 completed (key conventions, `si paas secret`, plaintext leakage guardrails, deploy-time vault trust/recipient checks, context namespace + vault file resolution); export/no-secret guardrails pending |
