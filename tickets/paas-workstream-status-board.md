...
| WS-11 | Dogfood state isolation and governance (MVP critical) | WS-02, WS-05, WS-09 | In Progress | Codex | 2026-02-17 | 2026-02-21 | None | WS11-01/02/03 completed (classification policy, context layout/init, and `si paas doctor` isolation checks); remaining ISO-governance slices pending (`WS11-04/05`) |
...
| Gate E2: State isolation hard gate | WS-11 | In Progress | Codex | WS11-01/02/03 completed; must finish WS11-04/05 before production dogfood rollout |
