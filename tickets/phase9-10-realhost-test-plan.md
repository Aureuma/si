...
3. GitHub-hosted workflow execution is intentionally out of scope for this ticket closeout; local real-host matrix completion is the recorded validation gate here.
