...
| Orbit marketplace | `si orbits ...` | [Orbit Marketplace](./ORBITS) |
...
| Orbit marketplace | policy + install diagnostics | N/A | catalog/install records | N/A | `si orbits doctor` |
...
| Orbit Marketplace | ![Orbit Marketplace](/docs/images/integrations/orbits.svg) |
