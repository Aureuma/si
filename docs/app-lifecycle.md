...
- Provision resources:
  - Per-app Postgres via `bin/app-db.sh create <app> [port]`.
...
- Secrets: rotate per-app DB via `app-db.sh drop/create` and update env; credentials dyad oversees rotations.
